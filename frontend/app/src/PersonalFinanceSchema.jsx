      ...
      <g id="Group 1">
        ...
        >
          ...
          <tspan x="699" y="201.455">
            (IC = $
            {amount_formatter.format(netPreTaxInflationCorrectedFinalValue)})
          </tspan>
        </text>
        <text
        ...
        >
          ...
          <tspan x="870" y="132.455">
            (IC = $
            {amount_formatter.format(netPreTaxInflationCorrectedFinalGain)})
          </tspan>
        </text>
        <text
        ...
        >
          ...
          <tspan x="1135" y="126.455">
            (IC = $
            {amount_formatter.format(netPostTaxInflationCorrectedFinalGain)})
          </tspan>
        </text>
        <text
        ...
        >
          ...
          <tspan x="1306" y="177.455">
            (IC = $
            {amount_formatter.format(netPostTaxInflationCorrectedFinalValue)})
          </tspan>
        </text>
        <text
