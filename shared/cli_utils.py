...
def load_and_register_commands(app: typer.Typer, dir_abspath: str, common_file_name: str = "run.py"):
    """
    ...
    for dir_name in os.listdir(dir_abspath):
        ...
        if os.path.isdir(dir_path) and os.path.exists(os.path.join(dir_path, common_file_name)):
